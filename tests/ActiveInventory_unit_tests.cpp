...
TEST(ActiveInventory, AddItem) {
    ...
    std::shared_ptr<PerishableItem> new_item{
        new PerishableItem("Apple", "Perishable", "None", "A5", "10", "0", "0", "1.50", "0.50", "0.10", "10/22/2023")};
    ...
    std::shared_ptr<PerishableItem> newer_item{
        new PerishableItem("Orange", "Perishable", "None", "A5", "10", "0", "0", "1.50", "0.50", "0.10", "10/22/2023")};
...
TEST(ActiveInventory, UpdateItem) {
    ...
    std::shared_ptr<PerishableItem> newer_item{new PerishableItem("Tangerine", "Perishable", "None", "A5", "10", "0",
                                                                  "1", "1.50", "0.50", "0.10", "10/22/2023")};
