...
class InventoryGenerator {
   ...
   protected:
    ...
    /* Expected columns */
    const std::vector<std::string> columns = {"Name",     "ID",         "Category",       "Sub-Category", "Location",
                                              "Quantity", "Back Order", "Sale Price",     "Tax",          "Total Price",
                                              "Buy Cost", "Profit",     "Expiration Date"};
